        ...
        <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-36">
          {/* <div className="hidden sm:mb-8 sm:flex sm:justify-center">
            <div className="relative rounded-full px-3 py-1 text-sm leading-6 text-gray-600 ring-1 ring-gray-900/10 hover:ring-gray-900/20">
              ...
              <a href="#" className="font-semibold text-indigo-600">
                ...
                Show <span aria-hidden="true">&rarr;</span>
              </a>
            </div>
          </div> */}
          <div className="flex items-center justify-center py-3 mx-auto w-full">
            <div className="relative rounded-full px-3 py-1 text-sm leading-6 text-gray-600 ring-1 ring-gray-900/10 hover:ring-gray-900/20">
              Announcing our next Event.{" "}
              <button
                onClick={openModal}
                      ...
                      <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                        ...
                        <div className="mt-2">
                          <p className="text-sm text-gray-500">
                            Here are the details for our upcoming event. Stay
          ...
          <div className="text-center">
            <h1 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">
              Mental Health Matters Brand and Community
            </h1>
