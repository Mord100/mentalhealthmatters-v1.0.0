...
const Footer = () => {
  return (
    <>
      <footer className="relative z-10 bg-white pb-10 pt-20 dark:bg-gray-800 lg:pb-20 lg:pt-[120px]">
            ...
            <div className="w-full px-4 sm:w-2/3 lg:w-3/12">
              <div className="mb-10 w-full">
                <a href="/#" className="mb-6 inline-block max-w-[160px]">
                  <img
                    src="https://i.ibb.co/GkG0Krz/brandmark-design-1024x0-copy.png"
                    alt="logo"
                ...
                <p className="mb-7 text-base text-body-color dark:text-dark-6">
                  Mental Wellness Clothing Brand
                </p>
            ...
            <div className="w-full px-4 sm:w-1/2 lg:w-3/12">
              <div className="mb-10 w-full">
                ...
                <p className="text-base text-body-color  text-white">
                  &copy; 2024 Mental Health Matters
                </p>
              </div>
            </div>
          </div>
  ...
  return (
    <>
      <div className="w-full px-4 sm:w-1/2 lg:w-2/12">
        <div className="mb-10 w-full">
          <h4 className="mb-9 text-lg font-semibold text-whte text-white">
            {header}
          </h4>
