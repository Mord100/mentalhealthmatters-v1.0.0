          ...
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
            <div>
              ...
              <p className="max-w-xs mt-4 text-sm text-gray-600">
                Mental health is an integral part of our overall well-being. It's important to recognize and address mental health issues to lead a balanced and fulfilling life. Whether you are struggling or seeking to support others, remember that help and resources are available.
              </p>
            ...
            <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:col-span-2 lg:grid-cols-4">
              ...
              <div>
                ...
                <nav className="flex flex-col mt-4 space-y-2 text-sm text-gray-600">
                  ...
                  <a className="hover:opacity-75" href> Our Values </a>
                </nav>
              </div>
              <div>
              ...
              <div>
                ...
                <nav className="flex flex-col mt-4 space-y-2 text-sm text-gray-600">
                  ...
                  <a className="hover:opacity-75" href> Refund Policy </a>
                  <a className="hover:opacity-75" href> Hiring Statistics </a>
                </nav>
              </div>
            </div>
          </div>
